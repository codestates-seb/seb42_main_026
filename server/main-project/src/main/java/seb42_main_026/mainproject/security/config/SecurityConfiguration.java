...
//        configuration.setAllowedMethods(Arrays.asList("GET", "POST", "PATCH", "DELETE")); // 파라미터로 지정한 HTTP Method에 대한 HTTP 통신을 허용한다.
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000/","http://ppongmangchi.net:8080/","https://codestates-seb.github.io/"));
...
>>>>>>> Stashed changes*/
    ...
    private ClientRegistration clientRegistration(){
        return CommonOAuth2Provider // 내부적으로 Builder 패턴을 이용해 ClientRegistration 인스턴스를 제공하는 역할이다.
                ...
                .redirectUri("http://ns-184.awsdns-23.com:8080/login/oauth2/code/google")
