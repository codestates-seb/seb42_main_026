...
//        configuration.setAllowedMethods(Arrays.asList("GET", "POST", "PATCH", "DELETE")); // 파라미터로 지정한 HTTP Method에 대한 HTTP 통신을 허용한다.
        configuration.setAllowedOriginPatterns(Arrays.asList("http://localhost:3000/","http://ppongmangchi.net:8080/","https://codestates-seb.github.io/, https://accounts.google.com/","http://seb42-main-026-fe.s3-website.ap-northeast-2.amazonaws.com/"));
