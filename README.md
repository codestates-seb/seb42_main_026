...
|</br>검색 / 최근 검색어</br>체크리스트 페이지</br>랭킹 페이지</br>회원 탈퇴 페이지</br>아이콘 디자인</br>마이페이지 / 로그아웃</br>회원 정보 수정 페이지</br>프로필 이미지 변경</br>AWS 배포 </br>CI/CD  구축</br></br>|</br>소셜 로그인 기능</br>태그 기능</br>모달 기능</br>무한스크롤 기능</br>이미지 압축</br>인기글페이지</br>전체게시글페이지</br></br>|</br>음성녹음 / 인코딩 및 재생</br>이미지 미리보기 / 업로드</br>게시글 CRUD</br>댓글 / 대댓글 CRUD</br>게시글 / 댓글 좋아요 기능</br>로그인 / 로그인 유지</br>상단 / 하단 메뉴바</br>회원가입 / 유효성검사</br>SSL인증서 / 도메인 연결</br>게시글 작성 페이지</br></br>|
